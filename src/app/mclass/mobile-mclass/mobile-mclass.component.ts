...
@Component({
  selector: 'app-mobile-mclass',
  templateUrl: './mobile-mclass.component.html',
  styleUrls: ['./mobile-mclass.component.scss']
})
export class MobileMclassComponent implements OnInit {
